  ...
  return (
    ...
    >
      <div className="relative">
        <User className="absolute left-3 top-1/2 -translate-y-1/2 text-[#8E8E8E]" size={20} />
        <input
      ...
      <div className="relative">
        <Mail className="absolute left-3 top-1/2 -translate-y-1/2 text-[#8E8E8E]" size={20} />
        <input
      ...
      <div className="relative">
        <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-[#8E8E8E]" size={20} />
        <input
      ...
      <button
        ...
        className={` border border-[#F0F0F0] w-full py-1.5 rounded-md font-bold ${
            errors.confirmPassword ? "cursor-not-allowed text-[#DDDDDD] bg-[#F0F0F0]" : "bg-[#3177a7] cursor-pointer"
          }`}
      >Submit</button>
    </form>
  );
